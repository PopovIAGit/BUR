...
PAGE 1: /* Data Memory */
	...
	LSARAM			: origin = 0x008000, length = 0x002000	/* on-chip RAM block L0 and L1 */
	H0SARAM			: origin = 0x3FA000, length = 0x002000	/* on-chip RAM block H0 */
}
...
SECTIONS
{
	...
	.ebss				: > LSARAM			PAGE = 1
	.sysmem			: > LSARAM			PAGE = 1
	.esysmem			: > LSARAM			PAGE = 1
