...
typedef struct _TGroupB
{
	...
	Uns 			BtEnable;			// В30. Разрешение Bluetooth: 0 - Включен; 1 - Выключен.
	Uns 			Rsvd31;				// 31.
...
//-----------------------Второстепенные настройки---------------------
	...
	Uns				NoControlKVOKVZ;	// 25. для инвертирования кво и квз на блоках 14 года, без доступа к прямому управлению
 	...
 	Int 			TrqMinPr;			// 27. Минимальное значение индикации момента 24.06.21 - для тяжпромараматуры
	Uns       		Rsvd5[6];           // 28-33.Резерв
...
#define REG_REV_CLOSE			GetAdr(GroupD.RevClose)
