...
//-----------------------Второстепенные настройки
	Int             BlockToGearRatio;   // 11.Коэффициент передачи блок-редуктор коэффициент скорости
	Uns             PhOrdZone;      	// 12.Расстояние чередования фаз двигателя
